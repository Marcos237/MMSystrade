...
namespace Systrade.Cadastro.UI.Mvc.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private readonly IRegistroAppService _registrousuarioappservice;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    _registrousuarioappservice.AdicionarRegistro(model.Login);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var result = _agenciaUsuarioAppService.AdicionarIdentidade(model);
        ...
        {
            _registrousuarioappservice.DeletarRegistroUsuario(Guid.Parse(UserId));
